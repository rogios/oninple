        ...
        <div className="hidden md:flex items-center gap-6">
          {navLinks.map((l) => (
            <Link
              key={l.href}
              href={l.href}
              className="text-sm font-medium text-gray-600 hover:text-[#E8292E] transition-colors"
            >
              {l.label}
            </Link>
          ))}
          ...
          {user ? (
            <div className="relative" ref={dropdownRef}>
              <button
                ...
                className="flex items-center gap-1.5 text-sm font-medium text-gray-700 hover:text-[#111111] px-3 py-1.5 rounded-lg hover:bg-gray-50 transition-colors"
              >
              ...
              {dropdownOpen && (
                <div className="absolute right-0 top-full mt-1.5 w-36 bg-white rounded-xl border border-gray-100 shadow-lg py-1 z-50">
                  {isAdmin && (
                    <>
                      <Link
                        href="/admin"
                        onClick={() => setDropdownOpen(false)}
                        className="flex items-center gap-2 px-4 py-2.5 text-sm text-[#E8292E] font-semibold hover:bg-red-50 transition-colors"
                      >
            ...
            <>
              <Link
                href="/login"
                className="text-sm font-medium text-gray-600 hover:text-[#111111] px-3 py-1.5 transition-colors"
              >
                로그인
              </Link>
              <Link
